...
class _ConfigPageState extends State<ConfigPage> 
{
  ...
  TextEditingController _gsrCharacteristicIdEditingController = TextEditingController();
  TextEditingController _tempCharacteristicIdEditingController = TextEditingController();
  TextEditingController _pulseCharacteristicIdEditingController = TextEditingController();
  ...
  {  
    ...
    _gsrCharacteristicIdEditingController.text = widget.globals.gsrCharacteristicId;
    _pulseCharacteristicIdEditingController.text = widget.globals.pulseCharacteristicId;
  }
  ...
  Future<void> saveSharedPreferences() async 
  {
    ...
    await widget.globals.prefs.setString('gsrCharacteristicId', widget.globals.gsrCharacteristicId);
    await widget.globals.prefs.setString('pulseCharacteristicId', widget.globals.pulseCharacteristicId);
  }
                ...
                [
                  ...
                  TextField(
                    onChanged: (value) 
                    {
                      setState(() 
                      {
                        widget.globals.gsrCharacteristicId = value;
                      });
                    },
                    controller: _gsrCharacteristicIdEditingController,
                  ),
                  SizedBox(height: 8.0),
                  Text('ENV'),
                  TextField
                  (
                    ...
                    controller: _tempCharacteristicIdEditingController,
                  ),
                  SizedBox(height: 8.0),
                  Text('ORIENTATION'),
                  TextField(
                    onChanged: (value) 
                    {
                      setState(() 
                      {
                        widget.globals.pulseCharacteristicId = value;
                      });
                    },
                    controller: _pulseCharacteristicIdEditingController,
                  ),
                  SizedBox(height: 16.0),
                  ElevatedButton
                  (
  ...
  Future<void> resetConfigVariables() async 
  {
    ...
    await widget.globals.prefs.setString('gsrCharacteristicId', defaults.gsrCharacteristicId);
    await widget.globals.prefs.setString('pulseCharacteristicId', defaults.pulseCharacteristicId);
  ...
  Future<void> loadConfigVariables() async 
  {
    ...
    widget.globals.gsrCharacteristicId =
        widget.globals.prefs.getString('gsrCharacteristicId') ??
            defaults.gsrCharacteristicId;
    widget.globals.pulseCharacteristicId =
        widget.globals.prefs.getString('pulseCharacteristicId') ??
            defaults.pulseCharacteristicId;

    
    widget.globals.receivedPGJsonValues=[];//TO DO save saved values not posted.
